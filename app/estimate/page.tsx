...
export default function EstimatePage() {
  ...
  const calculateArea = () => employees * 9;
  const calculateCost = () => {
    const baseCosts = {
      'office-partitioning': 1500,
      'office-renovation': 2000,
      'interior-decoration': 1200,
    };
        ...
        <div className="max-w-4xl mx-auto px-6">
              ...
              <div className="space-y-8">
                ...
                <div className="pt-6 border-t border-gray-100">
                  ...
                  <p className="text-[10px] uppercase font-bold text-gray-400 mt-3 leading-relaxed">
                    * Calculation based on standard 9m² per staff member including circulation and amenities.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-12 p-10 bg-black text-white rounded-xl flex flex-col md:flex-row justify-between items-center gap-8 border border-white/10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
              <Link href="/contact" className="bg-red-600 text-white px-10 py-5 rounded-lg font-black uppercase tracking-widest text-[11px] hover:bg-white hover:text-black transition-all text-center">
                Book Site Survey
              </Link>
              <Link href="/" className="border border-white/20 px-10 py-5 rounded-lg font-black uppercase tracking-widest text-[11px] hover:bg-white hover:text-black transition-all text-center">
                Back to Home
              </Link>
            </div>
          </div>
